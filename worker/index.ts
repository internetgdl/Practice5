export default {
  async fetch(request: Request, env: Env): Promise<Response> {
    ...
    try {
      ...
      // Log the error natively so Cloudflare Observability and Logpush can catch it
      console.error(`[Observability Test Error] Path: ${url.pathname} | Message: ${e.message}`, e.stack);
